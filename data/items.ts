export const items = [
  ...
  },
  {
    ...
    list1: "✅ Реалізувати сторінку створення поста /posts/create",
    list2:
      "✅ Зробити простий Stepper (3 кроки: Заголовок → Тіло → Попередній перегляд)",
    list3: "✅ Форми з TextField + іконки (TitleIcon, SubjectIcon)",
    list4: "✅ Додати базову валідацію (наприклад, обов'язкові поля)",
    list5: "✅ Snackbar при успішному створенні",
  },
];
